...
<div class="grid grid-cols-1 grid-rows-3 py-5 lg:grid-cols-11 lg:grid-rows-4">
    <div class="row-span-1 w-full lg:col-span-5 lg:row-span-full">
        <div class="flex flex-col mx-auto w-full max-w-xl h-full rounded-2xl">
            ...
            <div
                class="flex flex-col justify-between p-4 w-full leading-normal bg-white dark:bg-gray-900 dark:text-gray-50 rounded-b-xl border-r border-b border-l dark:border-gray-900 border-grey-light  lg:border-l-0 lg:border-t">
                <div class="flex flex-col mb-8 space-y-2">
                    <div
                        class="text-2xl dark:text-gray-50 text-dino-400 font-montserrat">{{$properties[0]->town." - ".$properties[0]->postcode}}</div>
                    <div
                        class="text-xl dark:text-gray-50 text-dino-400 font-montserrat">{{number_format($properties[0]->price, 0, ',', ' ')." €"}}</div>
                    <div
...
@endif ">
            <div class="mx-auto w-full max-w-xl rounded-2xl lg:flex">
                ...
                <div
                    class="flex flex-col justify-between p-4 w-full leading-normal bg-white dark:bg-gray-900  rounded-b rounded-b-xl border-r border-b border-l  dark:border-gray-900 border-grey-light lg:border-l-0 lg:border-t  lg:rounded-r-xl lg:rounded-b-none">
                    <div class="flex flex-col mb-8 space-y-2">
                        <div
                            class="text-2xl dark:text-gray-50 text-dino-400 font-montserrat">{{$properties[$index]->town." - ".$properties[$index]->postcode}}</div>
                        <div
                            class="text-xl dark:text-gray-50 text-dino-400 font-montserrat">{{number_format($properties[$index]->price, 0, ',', ' ')." €"}}</div>
                        <div
...
<h2 class="header-title mb-8">Les
