    ...
    <div class="max-w-screen-xl px-4 mx-auto">
        ...
        <div class="flex flex-col items-center justify-center pt-10 font-light text-center sm:pt-12">
            <form method="POST" action="{{route('pages.newsletter')}}"
                  ...
                  class="flex flex-col w-full max-w-lg space-x-3 space-y-4 md:flex-row">
                @csrf
                <div class="relative ">
                    <input type="email"
                           name="newsletterMail"
                           ...
                           class="flex-1 w-full px-4 py-2 text-base text-gray-700 placeholder-gray-400 bg-white border border-transparent border-gray-300 rounded-lg shadow-sm appearance-none  focus:outline-none focus:ring-2 focus:ring-black focus:border-transparent"
                           placeholder="Email"/>
                </div>
                <button
                    onclick="event.preventDefault();document.getElementById('storeNewsletterForm').submit();"
                    class="flex-shrink-0 px-4 py-2 text-base font-semibold text-white rounded-lg shadow-md bg-dino-800 hover:bg-dino-900 focus:outline-none focus:ring-2 focus:ring-dino-500 focus:ring-offset-2 focus:ring-offset-dino-200"
                    type="submit">
        ...
        <div
            class="mt-5 text-center text-footer">
