        ...
        <section class="relative text-gray-600 body-font">
            <div class="container flex flex-wrap px-5 py-24 mx-auto sm:flex-nowrap">
                <div
                    ...
                    <div class="relative flex flex-wrap py-6 bg-white dark:bg-gray-900 rounded shadow-md">
                        <div class="px-6 lg:w-1/2">
                            <h2 class="text-xs  dark:text-gray-50 font-semibold tracking-widest text-gray-900 title-font">
                                ADDRESSE</h2>
                            <p class="mt-1 dark:text-gray-200">6 Place Jacques Favrot, 72 666 Isla Nublar sur Sarthe,
                                France</p>
                        </div>
                        <div class="px-6 mt-4 lg:w-1/2 lg:mt-0">
                            <h2 class="text-xs font-semibold tracking-widest dark:text-gray-50 text-gray-900 title-font">
                                EMAIL</h2>
                            <a class="leading-relaxed dark:text-gray-200 text-dino-500">dino-vert@superDino.fr</a>
                            <h2 class="mt-4 text-xs font-semibold tracking-widest dark:text-gray-50 text-gray-900 title-font">
                                TELEPHONE</h2>
                            <p class="leading-relaxed dark:text-gray-200">06 66 66 66 66</p>
                        </div>
                    </div>
                </div>
                ...
                <form action="{{route('pages.storeContact')}}" method="post"
                      id="storeContactForm"
                      class="dark:bg-gray-900 flex flex-col w-full px-6 mt-8 bg-white rounded-lg shadow lg:w-1/3 md:w-1/2 md:ml-auto md:py-8 md:mt-0">
                    @csrf
                    @method('POST')
                    <h2 class="mb-1 text-lg font-medium dark:text-gray-50 text-gray-900 title-font">Feedback</h2>
                    <p class="mb-5 leading-relaxed dark:text-gray-200 text-gray-600">Vous voulez nous faire part d'un
                        remarque allez-y !
                        Nos dinosaures sont à vos soins.</p>
                    <div class="relative mb-4">
                        <label for="name" class="form-libel-create-edit">Prénom</label>
                        <input type="text" id="name" name="name" value="{{ old('name') }}" required
                               class="form-input-create-edit">
                        <x-error-form input="name"></x-error-form>
                    </div>
                    <div class="relative mb-4">
                        <label for="email" class="form-libel-create-edit">Email</label>
                        <input type="email" id="email" name="email" value="{{ old('email') }}" required
                               class="form-input-create-edit">
                        <x-error-form input="email"></x-error-form>
                    </div>
                    <div class="relative mb-4">
                        <label for="message" class="form-libel-create-edit">Message</label>
                        <textarea id="message" name="message" required
                                  class="form-input-create-edit">{{ old('message') }}</textarea>
                    ...
                    <div class="flex items-center mb-4 space-x-10">
                        ...
                        <label for="CGU" class="text-sm dark:text-gray-200 text-gray-700">J'accepte les CGU</label>
                    </div>
                    ...
                    <div class="flex items-center mb-4 space-x-10">
                        <div
                            ...
                            <label for="wantNewsletter"
                                   class="block h-6 overflow-hidden dark:text-gray-200 bg-gray-300 rounded-full cursor-pointer toggle-label"></label>
                        </div>
                        <label for="wantNewsletter" class="text-sm text-gray-700 dark:text-gray-200">S'abonner à la
                            newsletter</label>
                    </div>
