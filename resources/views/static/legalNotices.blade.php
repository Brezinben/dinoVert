    ...
    <div class="container mx-auto">
        ...
        <div class="text-dino-500 font-montserrat p-10 bg-white rounded-xl shadow-lg mb-5">
            ...
            <p>Nous vous recommandons de recourir à des navigateurs modernes comme Internet explorer, Safari, Firefox,
                Google Chrome, etc…</p>
            <p><span>L’<a
                        href="{{Request::root()}}">agence web AntheDesign</a><b>&nbsp;</b></span>met en œuvre
                tous
            ...
            <p class="text-lg my-2"><b>Cookies</b> : Le site <a
                ...
                demander l’acceptation des cookies pour des besoins de statistiques et d’affichage. Un <a
                    href="https://{{substr (Request::root(), 7)}}/autour-du-web/cookie/">cookie</a> est une information
                déposée sur
                votre
            ...
            <p>Les utilisateurs, les abonnés et les visiteurs des sites internet &nbsp;ne peuvent pas mettre en place un
                hyperlien en direction de ce site sans l’autorisation expresse et préalable de SARL Dino Vert.</p>
            <p>Dans l’hypothèse où un utilisateur ou visiteur souhaiterait mettre en place un hyperlien en direction
                d’un
                des sites internet de SARL Dino Vert, il lui appartiendra d’adresser un email accessible sur le site
                afin
            ...
            <p>
                ...
                des activités de la société ainsi que ses informations sont présentés sur notre site <a
                    href="{{Request::root()}}">{{substr (Request::root(), 7)}}</a>.</p>
            <p>SARL
                ANTHEDESIGN s’efforce de fournir sur le site {{substr (Request::root(), 7)}} des informations aussi
                précises que
                possible. Les renseignements figurant sur le site <a
                    href="{{Request::root()}}">{{substr (Request::root(), 7)}}</a> ne sont pas exhaustifs et les photos
                non
                contractuelles.</p>
            <p>Ils
                sont
            ...
            <p>Toute reproduction, distribution, modification, adaptation, retransmission ou publication, même
                partielle, de
                ces différents éléments est strictement interdite sans l’accord exprès par écrit de SARL Dino Vert.
                Cette
            ...
            <p>De manière générale, vous n’êtes pas tenu de nous communiquer vos données personnelles lorsque vous
                visitez
                notre site Internet <a href="{{Request::root()}}">{{substr (Request::root(), 7)}}</a>.</p>
            <p>Cependant, ce principe comporte certaines exceptions. En effet, pour certains services proposés par notre
                ...
                vous remplissez le formulaire qui vous est proposé en ligne, dans la rubrique « <a
                    href="https://{{substr (Request::root(), 7)}}/contact/">contact</a> ».</p>
            ...
            <p>Enfin, nous pouvons collecter de manière automatique certaines informations vous concernant lors d’une
                ...
                comme les zones que vous visitez et les services auxquels vous accédez, votre <a
                    href="https://{{substr (Request::root(), 7)}}/hebergement-web/adresse-ip/">adresse IP</a>, le type
                de votre
