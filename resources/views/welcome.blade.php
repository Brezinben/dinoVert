        ...
        <div class="grid grid-cols-1 auto-rows-max gap-8 mb-10 lg:grid-cols-3">
            @foreach($posts as $post)
                <div
                    ...
                    <img alt="blog photo" src="{{$post->imageUrl}}" class="object-cover w-full max-h-40 rounded-t-lg"/>
                    <div class="flex relative flex-col justify-start p-4 h-full dark:bg-gray-800">
                        <p class="mb-2 text-xl font-medium text-gray-800 dark:text-white">{{$post->title}}
                        </p>
                        <p class="font-light text-gray-400 dark:text-gray-300 text-md">
                            {{Str::limit($post->wysiwyg_text,250,' ... ') }}
                        </p>
                        <div class="flex flex-wrap justify-self-end items-center mt-4 justify-starts">
